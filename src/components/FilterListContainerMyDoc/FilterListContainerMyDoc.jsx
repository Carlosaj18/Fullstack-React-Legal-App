...
import "./FilterListContainerMyDoc.css";
import InputCheckBox from "../InputCheckBox/InputCheckBox";
import { ArrayDataContext } from "../../Contexto/ArrayDataProviderContext";

function FilterListContainerMyDoc({ childToParentCheckBox }) {
  let optionCheckBox = [
    "firmado",
    "sinFirma",
    "contratos",
      ...
      <div>
        <div className="firma">
          ...
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.signed === "firmado")
                .length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.signed === "sinFirma")
                .length
            }
          />
        </div>
        <div className="category">
          ...
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.category === "contratos")
                .length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.category === "acuerdos")
                .length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.category === "due-diligence"
              ).length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.category === "minutas")
                .length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.category === "templates")
                .length
            }
          />
        </div>
        <div className="etapas-contractuales">
          ...
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.state === "pre-contractual"
              ).length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.state === "contractual")
                .length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.state === "post-contractual"
              ).length
            }
          />
        </div>
        <div className="areas-juridicas">
          ...
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.area === "derecho-laboral"
              ).length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.area === "derecho-comercial"
              ).length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.area === "derecho-constitucional"
              ).length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.area === "derecho-administrativo"
              ).length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.area === "derecho-procesal"
              ).length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.area === "derecho-tributario"
              ).length
            }
          />
          <InputCheckBox
          ...
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter((item) => item.area === "derecho-civil")
                .length
            }
          />
          <InputCheckBox
            ...
            onload={
              arrayAPIMyDouments.filter(
                (item) => item.area === "derecho-digital"
              ).length
            }
          />
          <InputCheckBox
...
export default FilterListContainerMyDoc;
