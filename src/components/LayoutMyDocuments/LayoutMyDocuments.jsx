...
function LayoutMyDocuments(props) {
  ...
  return (
    <>
      <DocumentListContainer buttonFilter={props.buttonFilter} searchCheckBox={searchCheckBox} heading={<h3 style={style} className="heading">Estos son nuestros contratos y documentos legales listos para usar, construidos y revisados bajo los mayores estándares de calidad, y a precios inigualables.</h3>} documentTitle={props.documentTitle} subtitle="Mis Documentos"/>   
